...
define i32 @abs(i32 %0) {
	...
	%3 = load i32, i32* %2
	%4 = icmp sgt i32 %3, 0
	br i1 %4, label %_if_then_1, label %_if_else_2
...
_for_cond_1:
	%1 = load i32, i32* @i
	%2 = icmp slt i32 %1, 5
	br i1 %2, label %_for_loop_2, label %_for_next_3
...
_for_cond_4:
	%3 = load i32, i32* @j
	%4 = icmp slt i32 %3, 5
	br i1 %4, label %_for_loop_5, label %_for_next_6
...
_for_loop_5:
	...
	%6 = load i32, i32* @n
	%7 = icmp eq i32 %6, 1
	br i1 %7, label %_if_then_7, label %_if_else_8
