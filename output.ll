...
define i32 @A.f(%class.A* %0) {
	%2 = alloca %class.A*
	store %class.A* %0, %class.A** %2
	%3 = load %class.A*, %class.A** %2
	%4 = getelementptr %class.A, %class.A* %3, i32 0, i32 0
	%5 = load i32, i32*@a
	store i32 %5, i32* %4
	%6 = getelementptr %class.A, %class.A* %3, i32 0, i32 0
	%7 = load i32, i32* %6
	ret i32 %7
...
define i32 @main() {
	%1 = alloca %class.A
	call void @A.build(%class.A* %1)
	%2 = alloca i32
	%3 = call i32 @fff(i32 1, i32 2)
	store i32 %3, i32* %2
	%4 = load i32, i32* %2
